...
MyComponent.propTypes = {
  ...
  // React Docs: An object taking on a particular shape
  optionalObjectWithShape: PropTypes.shape({
...
// With PropTypes.element you can specify that only a single child
...
// by assigning to the special defaultProps property:
...
// This syntax has not yet been finalized though and will require a compilation
// step to work within a browser. For more information, see the class fields proposal.
...
class Greeting extends React.Component {
  ...
  // The defaultProps will be used to ensure that this.props.name will
  // have a value if it was not specified by the parent component.
